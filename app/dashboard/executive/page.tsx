...
export default function executive() {  
  return (
    <div className="p-6 bg-brandGrey-50 mx-auto w-full">
      <h1 className="text-3xl font-bold mb-6">임원대시보드</h1>

      <div className='flex flex-col xl:flex-row gap-6 w-full'>
        {/* 왼쪽: 기존 카드들 */}
        <div className="flex flex-col gap-5 w-full xl:w-1/4">
          <Card1
            title="전체 책무세부내용"
            mainValue="119개"
        ...
        {/* 오른쪽: 도넛 차트들 */}
        <div className="flex flex-col lg:flex-row gap-6 w-full xl:w-3/4">
