  ...
  return (
    <div className="p-4 h-full bg-white rounded-xl shadow-sm border border-gray-100">
      <div className="flex justify-between items-center">
        <div className="text-gray-900 font-bold">Satisfaction</div>
        <MoreHorizontal className="w-4 h-4 text-gray-500" />
      </div>
      <div className="mt-3 text-gray-600">From all projects</div>
      <div className="flex justify-center mt-4">
        <div className="relative">
          ...
          >
            ...
            />
            <circle cx="560" cy="350" r="12" fill="#fff" />
      ...
      <div className="flex justify-center">
        <div className="flex justify-between mt-2" style={{ width: '300px' }}>
          <div className="text-xs text-gray-500" style={{ width: '50px', paddingLeft: '16px' }}>
            0%
          </div>
          <div className="text-center" style={{ width: '150px' }}>
            ...
            <div className="text-xs text-gray-500">Based on Likes</div>
          </div>
          <div className="text-xs text-gray-500" style={{ width: '50px' }}>
            100%
          </div>
        </div>
      </div>
