...
import { ExecutiveResponsibilityFormData, ResponsibilityData } from "@/types"
import { mockResponsibilityData, mockExecutiveResponsibilityData } from "@/data/mockData"

interface AddExecutiveResponsibilityModalProps {
  isOpen: boolean
  onClose: () => void
  onAdd: (data: ExecutiveResponsibilityFormData) => void
}

export default function AddExecutiveResponsibilityModal({ isOpen, onClose, onAdd }: AddExecutiveResponsibilityModalProps) {
      ...
      <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle className="flex items-center gap-2">
            <Plus className="w-5 h-5" />새 임원 관리조치 등록
          </DialogTitle>
        ...
        <div className="space-y-6 py-4">
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="space-y-2">
              ...
              <Select onValueChange={handleExecutiveChange}>
