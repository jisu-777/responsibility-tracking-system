...
interface AddResponsibilityModalProps {
  isOpen: boolean
  onClose: () => void
  onAdd: (data: ResponsibilityFormData) => void
}
...
export default function AddResponsibilityModal({ isOpen, onClose, onAdd }: AddResponsibilityModalProps) {
      ...
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle className="flex items-center gap-2">
            <Plus className="w-5 h-5" />새 책무 등록
          </DialogTitle>
